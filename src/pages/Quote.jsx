      ...
      <main className="quote-page">
        <section className="quote-summary">
          <div className="quote-content">
            ...
            {quote.items.length > 0 && (<div className="quote-summary-info">
            ...
            <div className="quote-items">
              {quote.items.length ? (<>
                  ...
                  {quote.items.map(item => (<article key={item.id} className="quote-item">
            ...
            <form className="quote-send" onSubmit={(e) => { e.preventDefault(); sendQuote(); }}>
              <div className="form-section">
                ...
                <div className="form-group">
                  ...
                  <input id="clientName" type="text" value={quote.clientName} placeholder="Ex: João Silva" onChange={e => updateQuoteField('clientName', e.target.value)}/>
                </div>
                <div className="form-row">
                  <div className="form-group">
                    <label htmlFor="clientEmail">Email</label>
                    <input id="clientEmail" type="email" value={quote.clientEmail} placeholder="cliente@exemplo.com" onChange={e => updateQuoteField('clientEmail', e.target.value)}/>
                  </div>
                  <div className="form-group">
                    <label htmlFor="clientPhone">Telefone</label>
                    <input id="clientPhone" type="tel" value={quote.clientPhone} placeholder="(11) 91234-5678" onChange={e => updateQuoteField('clientPhone', e.target.value)}/>
                  </div>
                </div>
              </div>
              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  ...
                  <input id="eventName" type="text" value={quote.eventName} placeholder="Ex: Casamento, Aniversário" onChange={e => updateQuoteField('eventName', e.target.value)}/>
                </div>
                <div className="form-group">
                  <label htmlFor="organizerEmail">Email do organizador</label>
                  <input id="organizerEmail" type="email" value={email} placeholder="organizador@exemplo.com" onChange={e => setEmail(e.target.value)}/>
                </div>
              </div>

              <button type="submit" className="submit-button" disabled={!quote.items.length || !email || !quote.clientName || !quote.clientEmail}>
                ✓ Enviar Orçamento
              </button>
          ...
          <div className="service-image-container">
            <div className="image-frame">
              <img src={`${baseUrl}orcamentoeventos.webp`} alt="Orçamento de eventos" className="service-title-image"/>
            </div>
          </div>
        </section>
