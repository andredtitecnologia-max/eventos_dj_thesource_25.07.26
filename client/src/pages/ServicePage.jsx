        ...
        <section className="service-details">
          ...
          {service.id === 'sonorizacao' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/audio-equipment.png" alt="Equipamento de sonorização" className="service-title-image"/>
              </div>
            </div>)}
          {service.id === 'iluminacao' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/sonorizacao-equipment.png" alt="Equipamento de iluminação" className="service-title-image"/>
              </div>
            </div>)}
          {service.id === 'garcons' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/garcons.jpg" alt="Garçons profissionais" className="service-title-image"/>
              </div>
            </div>)}
          {service.id === 'djs' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/djs.jpg" alt="DJ profissional" className="service-title-image"/>
              </div>
            </div>)}
          {service.id === 'decoracao' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/decorador.jpg" alt="Decorador profissional" className="service-title-image"/>
              </div>
            </div>)}
          {service.id === 'salao' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/salaoeventos.jpg" alt="Salão de eventos" className="service-title-image"/>
              </div>
            </div>)}
          {service.id === 'recepcionistas' && (<div className="service-image-container">
              <div className="image-frame">
                <img src="/recepcionista.jpg" alt="Recepcionistas profissionais" className="service-title-image"/>
              </div>
            </div>)}
        </section>
      </main>
